/*global sitemap, d3, options, console, _*/

(function() {
  sitemap.pagesView = sitemap.D3View(function(svg) {
    ...
    svg.enter = function(node, opts) {
      var g = node.append("g")
          .attr("class", "node")
          .attr("id", function(d) { return 'node:'+ d.page.cid; })
          .attr("transform", transformStart);
  ...
  sitemap.pageView = sitemap.D3View(function(svg) {
    svg.enter = function(node, opts) {
